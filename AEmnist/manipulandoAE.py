...
autoencoder_history = autoencoder.fit(
    ...
    shuffle = True,
    # usamos o conjunto validação interna do treinamento
    validation_data =(x_valid, x_valid)
)

# realizar a codificação do conjunto de validação
